...
// project is the name of the model it's assigned the model and schema from mongoose.
...
let projects = [{
    ...
    "author": "Redactor",
    "PublishedAt": "Published on the {{$ctrl.project.PublishedAt*1000 | date:' dd-MMMM-yyyy  @  hh:mm'}}  ",
...
projects.forEach(function(project, index) {
      //project is the model of mongoose exported by express from project.js
